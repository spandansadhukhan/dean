...
if (!$fp)
...
else
 {
    ...
    if($_POST['payment_status']=="Completed" and !empty($_REQUEST['txn_id']))
    {
            ...
            mysql_query("update advertisements set  is_paid=1,txn_id='".$_REQUEST['txn_id']."' where id='".$adid."'");
            $to = "nits.karunadri@gmail.com";
            $subject = "IPN";
            $txt = "update advertisements set  is_paid=1,txn_id='".$_REQUEST['txn_id']."' where id='".$adid."'";
