...
class UsersController extends AppController {
    ...
    public function frontUserLogin() {
        ...
        pr($this->request->data); //exit;
        $this->User->recursive = -1;
        $options = array('conditions' => array('User.email' => $this->request->data['email'], 'User.password' => md5($this->request->data['pass']), 'User.is_active' => 1, 'User.is_admin' => 0));
        $loginuser = $this->User->find('first', $options);
        //pr($loginuser); exit;
        ...
        if (!$loginuser) {
            ...
            if ($loginuser['User']['user_type'] == "E") {
                $this->Session->write('fdashboard', 'escortdashboard');
    ...
    public function escortdashboard() {
          ...
          if(!isset($usertype) && $usertype != 'E'){ $this->Session->setFlash('You are not authorised for that page. Please logged in as Escort'); return $this->redirect(array('action' => 'index')); }

           // echo($this->Session->read('flogin')); echo "<br>"; echo($this->Session->read('fuid')); echo "<br>";
           // echo($this->Session->read('futype')); echo "<br>"; pr($this->Session->read('fdet')); exit;
    ...
    public function userdashboard() {
        ...
        $userid   = $this->Session->read('fuid');
        $usertype = $this->Session->read('futype');
        if(isset($usertype) && $usertype != 'U'){ $this->Session->setFlash('You are not authorised for that page. Please logged in as User'); return $this->redirect(array('action' => 'index')); }
    ...
    public function agencydashboard() {
        ...
        $userid   = $this->Session->read('fuid');
        $usertype = $this->Session->read('futype');
        if(isset($usertype) && $usertype != 'A'){ $this->Session->setFlash('You are not authorised for that page. Please logged in as User'); return $this->redirect(array('action' => 'index')); }
    ...
    public function clubdashboard() {
          ...
          if(isset($usertype) && $usertype != 'C'){ $this->Session->setFlash('You are not authorised for that page. Please logged in as Club'); return $this->redirect(array('action' => 'index')); }
    ...
    public function editclubprofile() {
        ...
        $userid   = $this->Session->read('fuid');
        $usertype = $this->Session->read('futype');
        if(isset($usertype) && $usertype != 'C'){ $this->Session->setFlash('You are not authorised for that page. Please logged in as User'); return $this->redirect(array('action' => 'index')); }
    ...
    public function parlordashboard() {
        ...
        $userid   = $this->Session->read('fuid');
        $usertype = $this->Session->read('futype');
        if(isset($usertype) && $usertype != 'P'){ $this->Session->setFlash('You are not authorised for that page. Please logged in as User'); return $this->redirect(array('action' => 'index')); }
