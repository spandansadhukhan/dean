...
//pr($images);exit;
    ...
    public function index() {
        ...
        // if(isset($id) || $id != '') {
        //     $options = array('conditions' => array('User.user_type' => 'E','User.category_id' => base64_decode($id)));
        // }else{
        // }
        ...
        $this->set(compact('escorts', 'category'));
    }
