                            ...
                            <div class="checkbox_search">
                            	<ul>
                                    <form method="post" id="SearchCheck">
                                        ...
                                        <li><input type="checkbox" name="category_id[]" value="4" class="searcheck" onclick="ajaxSearch()"  /> <span>Private</span></li>
                                        <li><input type="checkbox" name="category_id[]" value="5" class="searcheck" onclick="ajaxSearch()" /> <span>Agency Club</span></li>
                                        ...
                                        <li><input type="checkbox" name="category_id[]" value="8" onclick="ajaxSearch()" /> <span>Non Asian</span></li>
                                        <li><input type="checkbox" name="category_id[]" value="7" onclick="ajaxSearch()" /> <span>Asian</span></li>
                                    </form>
