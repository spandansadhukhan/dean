  ...
  <div class="wrapper">
	...
	<tr class="gradeX">
		...
		<td><?php echo h(++$sl_no); ?>&nbsp;</td>
                <td><?php echo h($category['BlogCategory']['name']); ?>&nbsp;</td>
                <td><?php if($category['BlogCategory']['status']==1) {echo 'Active';} else { echo 'Inactive';} ?>&nbsp;</td>
                <td><?php echo date('Y-m-d',strtotime($category['BlogCategory']['add_date']));?>&nbsp;</td>
                <td class="text-center">
                                    <div class="btn-group btn-group-sm">  



                                        <a href="javascript:void(0);" onclick="edit(<?php echo $category['BlogCategory']['id'];?>)" class="btn btn-info enable-tooltip" data-original-title="Manage Account"><i class="fa fa-sign-in"></i></a>

                                        <a href="javascript:void(0);" onclick="del(<?php echo $category['BlogCategory']['id'];?>)" class="btn btn-danger enable-tooltip" data-original-title="Delete Record"><i class="fa fa-times"></i></a>

          <?php if($category['BlogCategory']['status']== 1){ ?>
                                        <a href="javascript:void(0);"  onclick="active(<?php echo $category['BlogCategory']['id'];?>)" class="btn btn-success enable-tooltip" data-original-title="Inactive Record"><i class="fa fa-circle-o"></i></a>

          <?php } else if($category['BlogCategory']['status']== 0){ ?>
                                        <a href="javascript:void(0);" onclick="Inactive(<?php echo $category['BlogCategory']['id'];?>)" class="btn btn-warning enable-tooltip" data-original-title="Inactive Record"><i class="fa fa-circle-o"></i></a>
          <?php } ?>
