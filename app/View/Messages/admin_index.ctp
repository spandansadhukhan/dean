            ...
            <a href=#" class="widget widget-hover-effect1">
                <div class="widget-simple">
                    ...
                    <h3 class="widget-content text-right animation-pullDown">
                        ...
                        <small><?php echo $total_message;?></small>
                    </h3>
                </div>
            </a>
        </div>
            ...
            <a href="#" class="widget widget-hover-effect1">
                <div class="widget-simple">
                    ...
                    <h3 class="widget-content text-right text-success animation-pullDown">
                        ...
                        <small><?php echo $read_message;?></small>
                    </h3>
                </div>
            </a>
        </div>
            ...
            <a href="#" class="widget widget-hover-effect1">
                <div class="widget-simple">
                    ...
                    <h3 class="widget-content text-right text-warning animation-pullDown">
                        ...
                        <small><?php echo $unread_message;?></small>
                    </h3>
                </div>
            </a>
        </div>
    ...
    <div class="row gap_row">
      <div class="col-sm-12">
        ...
        <header class="panel-heading">
            All User Communications  (Total Records: <?php echo $total_message; ?>)
        </header>
            ...
            <div class="table-options clearfix" style=" background-color:#fff">
				...
				<div class="btn-group btn-group-sm pull-left">
						<div class="input-group">
                                                     <?php echo $this->Form->input("title",array("type"=>"text",'class'=>'form-control col-md-6','placeholder'=>'Search by subject...','label'=>false))?>
...
<!--                <div class="btn-group btn-group-sm pull-right">
       ...
       <div class="block-title">
        <div class="block-options pull-right form-actions">
            <button class="btn btn-alt btn-sm btn-danger enable-tooltip" id="advanceSearch_close" type="button" data-original-title="Advance Search close"  data-toggle="tooltip" data-placement="top" title="Advance Search Close" onclick="advance_close();"><i class="fa fa-times"></i></button>
             <button class="btn btn-alt btn-sm btn-warning enable-tooltip" onclick="location.href='<?php echo $this->webroot;?>admin/messages'" type="button" data-original-title="Reset Search" data-toggle="tooltip" data-placement="top" title="Reset Search"><i class="fa fa-repeat"></i></button>
        </div>
       <h2><strong>Advance </strong>Search</h2>
                               ...
                               <div class="form-inline">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->input("title",array('type'=>"text",'class'=>'form-control','placeholder'=>'Search by   subject...','label'=>false,'div'=>false))?>
                                       ...
                                       <div class="form-group">
                                         ...
                                         <br>
                                         <?php
                                            echo $this->Form->input("is_read",array('options'=>$ad_types,'class'=>'select-chosen','data-placeholder'=>'Choose a Type..','style'=>'width: 250px','selected'=>!empty($this->request->data['Filter']['is_active'])?$this->request->data['Filter']['is_active']:'','label'=>false,'div'=>false));
	...
	<tr>
		...
		<th><?php echo $this->Paginator->sort('to_id','Receiver'); ?></th>
                <th><?php echo $this->Paginator->sort('title','Subject'); ?></th>
		<th><?php echo $this->Paginator->sort('posttime','Added On'); ?></th>
	...
	<?php foreach ($messages as $content):
	    ...
	    ?>
        <tr class="gradeX">
            <td><input type="checkbox" class="changestatus" value="<?php echo $content["Message"]["id"]; ?>"></td>
        <td><?php echo $content["Message"]["id"]; ?></td>
        <td><?php echo $content["FromUser"]["name"]; ?></td>
        <td><?php echo $content["User"]["name"]; ?></td>
        <td><?php echo $content["Message"]["title"]; ?></td>
        <td><?php echo date("Y-m-d h:i a",strtotime($content["Message"]["posttime"])); ?></td>
        <td class="text-center">
        <div class="btn-group btn-group-sm">
            <a href="javascript:void(0);" onclick="viewad(<?php echo $content['Message']['id']; ?>)" class="btn btn-default enable-tooltip view-record" data-original-title="View Record"><i class="fa fa-search"></i></a>
            <a href="javascript:void(0)" onclick="del(<?php echo $content['Message']['id'];?>)" class="btn btn-default enable-tooltip view-record btn btn-primary" data-original-title="View Record" onclick="bulk_delete()"><i class="fa fa-times" aria-hidden="true"></i></a>
...
function viewad(userid){
  //alert(userid);
	$.get('<?php echo($this->webroot)?>admin/messages/view/'+userid,function(data){
        $("#myModal").modal("show");   
...
function del(aa){
  var a=confirm("Are you sure, you want to delete this?")
      if (a)
      {
        location.href="<?php echo $this->webroot?>admin/messages/delete/"+aa;
      } 
}
...
function bulk_delete()
{
    ...
    
    {
        ...
        if (a)
        {
            ...
            $.post("<?php echo $this->webroot;?>admin/messages/bulkdelete/",data,function(result){
            if(result.trim()==1)    
            {
             location.href="<?php echo $this->webroot; ?>admin/messages/index";
            }
            else
            {
             location.reload();
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">User CommunicationsDetail </h4>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" method="post" action="<?php echo $this->webroot; ?>admin/messages/reply">
