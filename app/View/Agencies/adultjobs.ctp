...
<div class="col-left">
<link href="http://layout9.demoparlour.com/advdirectory/assets/layout9/css/new-tab.css" rel="stylesheet">
<script src="http://layout9.demoparlour.com/advdirectory/assets/layout9/js/new-tab2.js" type="text/javascript"></script>
<script src="http://layout9.demoparlour.com/advdirectory/assets/layout9/js/new.js" type="text/javascript"></script>
<link rel="stylesheet" href="http://layout9.demoparlour.com/advdirectory/assets/layout9/datepicker/datepicker.css"/>
<script src="http://layout9.demoparlour.com/advdirectory/assets/layout9/datepicker/datepicker.js"></script>
<style>
.for-tour input[type="text"], .for-tour input[type="password"], .for-tour textarea, .for-tour select {
	width: 52% !important;
}
</style>
<script type="text/javascript">
var maxdate = '2018,10,14';
var currentDate = '2016/10/14';
...
$(function() {
  ...
  {maxDate: '0'});
			...
			$("input[name^=start_date]").datepicker("setDate",currentDate);
   ...
   $( "input[name^=end_date]" ).datepicker(
  {
	...
	dateFormat: "yy/mm/dd" },
  {maxDate: '0'});
  		$("input[name^=end_date]").datepicker("setDate",currentDate);
		});
...
function deleteAd(id)
{
	...
	if (result)
	{
		...
		var posturl=siteurl+'manage-adult-job/doTask/Delete/'+id;
		$.ajax({
		url: posturl,
		dataType: 'json',
		type: "GET",
...
{
	BootstrapDialog.confirm('Are you sure to '+task+' this job?', function(result){
	if (result)
	{
		var siteurl="http://layout9.demoparlour.com/advdirectory/";
		var posturl=siteurl+'manage-adult-job/doTask/'+task+'/'+id;
		$.ajax({
		url: posturl,
		dataType: 'json',
		type: "GET",
            ...
            <div class="right-my-account-blocks">
              <div class="detail-heading">
                <section class="title-left">
                  <h1 style="display:inline-block;">Manage Adult Jobs</h1>
                </section>
                <div class="clr"></div>
              </div>
