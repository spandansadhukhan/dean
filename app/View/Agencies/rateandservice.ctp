                                                                ...
                                                                <div  class="form-profile-block">
                                                                    <div id="categorydiv"  >
                                                                        <div class="option-group field" id="categoryInput">
                                                                            ...
                                                                            <!--
                                                                            <div class="fleft city-title" id="category-li-id_13">
                                                                                    <input style="opacity:0; position:absolute;" type="checkbox"  checked="checked" 
                                                                                           value="13" id="category13" name="category[]" onclick="removeCategory('13')" >
                                                                                    <label for="category13" style="color:#FEFFFF;">Russian Escorts</label>
                                                                                    <a class="icon-remove" onclick="removeCategory('13')"></a>
                                                                            </div>
                                                                            -->
                                                    ...
                                                    <div class="table-responsive for-msg">
                                                        <table class="table table-vcenter table-striped">
                                                            ...
                                                            <tr>
                                                                <td colspan="4">
                                                                    <div class="smart-forms">
                                                                        <div id="save_incall_outcall_charge_error1_Hour_container" style="display:none;" class="error_message notification alert-error spacer-t5"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_error1_Hour"></span></div>
                                                                        <div id="save_incall_outcall_charge_success1_Hour_container" style="display:none;" class="success_message notification alert-success spacer-t10"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_success1_Hour"></span></div>		
                                                                    </div>
                                                                    <form method="post" accept-charset="utf-8" id="add_incall_outcall_price_to_escort1_Hour">															<table>	
                                                                            <tr>
                                                                                <td style="width: 120px;">1 Hour</td>
                                                                                <td>
                                                                                    <input type="hidden" name="time" value="1_Hour" />
                                                                                    <input type="text" name="price_in_call" id="1_Hour_in_call" maxlength="6" value="" />
                                                                                </td>
                                                                                <td><input type="text" name="price_out_call" id="1_Hour_out_call" maxlength="6" value="" /></td>
                                                                                <td>
                                                                                    <div class="config-group">
                                                                                        <div class="group">
                                                                                            <div class="button-box autoplay column-2">
                                                                                                <input type="hidden" id="currency_name_2" name="curency" value="EUR"/> 
                                                                                                <a class="table-bt" href="javascript:void(0)" style="display:block; width:auto;" onclick = "submit_incall_outcall_category_form('1_Hour')" >Save</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="4">
                                                                    <div class="smart-forms">
                                                                        <div id="save_incall_outcall_charge_error2_Hour_container" style="display:none;" class="error_message notification alert-error spacer-t5"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_error2_Hour"></span></div>
                                                                        <div id="save_incall_outcall_charge_success2_Hour_container" style="display:none;" class="success_message notification alert-success spacer-t10"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_success2_Hour"></span></div>		
                                                                    </div>
                                                                    <form method="post" accept-charset="utf-8" id="add_incall_outcall_price_to_escort2_Hour">															<table>	
                                                                            <tr>
                                                                                <td style="width: 120px;">2 Hour</td>
                                                                                <td>
                                                                                    <input type="hidden" name="time" value="2_Hour" />
                                                                                    <input type="text" name="price_in_call" id="2_Hour_in_call" maxlength="6" value="" />
                                                                                </td>
                                                                                <td><input type="text" name="price_out_call" id="2_Hour_out_call" 
                                                                                           maxlength="6" value="" /></td>
                                                                                <td>
                                                                                    <div class="config-group">
                                                                                        <div class="group">
                                                                                            <div class="button-box autoplay column-2">
                                                                                                <input type="hidden" id="currency_name_3" 
                                                                                                       name="curency" value="EUR"/> 
                                                                                                <a class="table-bt" href="javascript:void(0)" style="display:block; width:auto;" onclick = "submit_incall_outcall_category_form('2_Hour')" >Save</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="4">
                                                                    <div class="smart-forms">
                                                                        <div id="save_incall_outcall_charge_error3_Hour_container" style="display:none;" class="error_message notification alert-error spacer-t5"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_error3_Hour"></span></div>
                                                                        <div id="save_incall_outcall_charge_success3_Hour_container" style="display:none;" class="success_message notification alert-success spacer-t10"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_success3_Hour"></span></div>		
                                                                    </div>
                                                                    <form method="post" accept-charset="utf-8" id="add_incall_outcall_price_to_escort3_Hour">															<table>	
                                                                            <tr>
                                                                                <td style="width: 120px;">3 Hour</td>
                                                                                <td>
                                                                                    <input type="hidden" name="time" value="3_Hour" />
                                                                                    <input type="text" name="price_in_call" id="3_Hour_in_call" maxlength="6" value="" />
                                                                                </td>
                                                                                <td><input type="text" name="price_out_call" id="3_Hour_out_call" maxlength="6" value="" /></td>
                                                                                <td>
                                                                                    <div class="config-group">
                                                                                        <div class="group">
                                                                                            <div class="button-box autoplay column-2">
                                                                                                <input type="hidden" id="currency_name_4" name="curency" value="EUR"/> 
                                                                                                <a class="table-bt" href="javascript:void(0)" style="display:block; width:auto;" onclick = "submit_incall_outcall_category_form('3_Hour')" >Save</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="4">
                                                                    <div class="smart-forms">
                                                                        <div id="save_incall_outcall_charge_errorAdditional_Hours_container" style="display:none;" class="error_message notification alert-error spacer-t5"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_errorAdditional_Hours"></span></div>
                                                                        <div id="save_incall_outcall_charge_successAdditional_Hours_container" style="display:none;" class="success_message notification alert-success spacer-t10"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_successAdditional_Hours"></span></div>		
                                                                    </div>
                                                                    <form method="post" accept-charset="utf-8" id="add_incall_outcall_price_to_escortAdditional_Hours">															<table>	
                                                                            <tr>
                                                                                <td style="width: 120px;">Additional Hours</td>
                                                                                <td>
                                                                                    <input type="hidden" name="time" value="Additional_Hours" />
                                                                                    <input type="text" name="price_in_call" id="Additional_Hours_in_call" maxlength="6" value="" />
                                                                                </td>
                                                                                <td><input type="text" name="price_out_call" id="Additional_Hours_out_call" maxlength="6" value="" /></td>
                                                                                <td>
                                                                                    <div class="config-group">
                                                                                        <div class="group">
                                                                                            <div class="button-box autoplay column-2">
                                                                                                <input type="hidden" id="currency_name_5" name="curency" value="EUR"/> 
                                                                                                <a class="table-bt" href="javascript:void(0)" style="display:block; width:auto;" onclick = "submit_incall_outcall_category_form('Additional_Hours')" >Save</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="4">
                                                                    <div class="smart-forms">
                                                                        <div id="save_incall_outcall_charge_errorOvernight_container" style="display:none;" class="error_message notification alert-error spacer-t5"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_errorOvernight"></span></div>
                                                                        <div id="save_incall_outcall_charge_successOvernight_container" style="display:none;" class="success_message notification alert-success spacer-t10"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_successOvernight"></span></div>		
                                                                    </div>
                                                                    <form method="post" accept-charset="utf-8" id="add_incall_outcall_price_to_escortOvernight">															<table>	
                                                                            <tr>
                                                                                <td style="width: 120px;">Overnight</td>
                                                                                <td>
                                                                                    <input type="hidden" name="time" value="Overnight" />
                                                                                    <input type="text" name="price_in_call" id="Overnight_in_call" maxlength="6" value="" />
                                                                                </td>
                                                                                <td><input type="text" name="price_out_call" id="Overnight_out_call" maxlength="6" value="" /></td>
                                                                                <td>
                                                                                    <div class="config-group">
                                                                                        <div class="group">
                                                                                            <div class="button-box autoplay column-2">
                                                                                                <input type="hidden" id="currency_name_6" name="curency" value="EUR"/> 
                                                                                                <a class="table-bt" href="javascript:void(0)" style="display:block; width:auto;" onclick = "submit_incall_outcall_category_form('Overnight')" >Save</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="4">
                                                                    <div class="smart-forms">
                                                                        <div id="save_incall_outcall_charge_error1_Day_container" style="display:none;" class="error_message notification alert-error spacer-t5"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_error1_Day"></span></div>
                                                                        <div id="save_incall_outcall_charge_success1_Day_container" style="display:none;" class="success_message notification alert-success spacer-t10"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_success1_Day"></span></div>		
                                                                    </div>
                                                                    <form  method="post" accept-charset="utf-8" id="add_incall_outcall_price_to_escort1_Day">															<table>	
                                                                            <tr>
                                                                                <td style="width: 120px;">1 Day</td>
                                                                                <td>
                                                                                    <input type="hidden" name="time" value="1_Day" />
                                                                                    <input type="text" name="price_in_call" id="1_Day_in_call" maxlength="6" value="" />
                                                                                </td>
                                                                                <td><input type="text" name="price_out_call" id="1_Day_out_call" maxlength="6" value="" /></td>
                                                                                <td>
                                                                                    <div class="config-group">
                                                                                        <div class="group">
                                                                                            <div class="button-box autoplay column-2">
                                                                                                <input type="hidden" id="currency_name_7" name="curency" value="EUR"/> 
                                                                                                <a class="table-bt" href="javascript:void(0)" style="display:block; width:auto;" onclick = "submit_incall_outcall_category_form('1_Day')" >Save</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="4">
                                                                    <div class="smart-forms">
                                                                        <div id="save_incall_outcall_charge_error2_Day_container" style="display:none;" class="error_message notification alert-error spacer-t5"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_error2_Day"></span></div>
                                                                        <div id="save_incall_outcall_charge_success2_Day_container" style="display:none;" class="success_message notification alert-success spacer-t10"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_success2_Day"></span></div>		
                                                                    </div>
                                                                    <form  method="post" accept-charset="utf-8" id="add_incall_outcall_price_to_escort2_Day">															
                                                                        <table>	
                                                                            <tr>
                                                                                <td style="width: 120px;">2 Day</td>
                                                                                <td>
                                                                                    <input type="hidden" name="time" value="2_Day" />
                                                                                    <input type="text" name="price_in_call" id="2_Day_in_call" maxlength="6" value="" />
                                                                                </td>
                                                                                <td><input type="text" name="price_out_call" id="2_Day_out_call" maxlength="6" value="" /></td>
                                                                                <td>
                                                                                    <div class="config-group">
                                                                                        <div class="group">
                                                                                            <div class="button-box autoplay column-2">
                                                                                                <input type="hidden" id="currency_name_8" name="curency" value="EUR"/> 
                                                                                                <a class="table-bt" href="javascript:void(0)" style="display:block; width:auto;" onclick = "submit_incall_outcall_category_form('2_Day')" >Save</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="4">
                                                                    <div class="smart-forms">
                                                                        <div id="save_incall_outcall_charge_errorWeekend_container" style="display:none;" class="error_message notification alert-error spacer-t5"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_errorWeekend"></span></div>
                                                                        <div id="save_incall_outcall_charge_successWeekend_container" style="display:none;" class="success_message notification alert-success spacer-t10"><a class="close-btn" onClick="close_div();" href="javascript:;">�</a><span id="save_incall_outcall_charge_successWeekend"></span></div>		
                                                                    </div>
                                                                    <form method="post" accept-charset="utf-8" id="add_incall_outcall_price_to_escortWeekend">															<table>	
                                                                            <tr>
                                                                                <td style="width: 120px;">Weekend</td>
                                                                                <td>
                                                                                    <input type="hidden" name="time" value="Weekend" />
                                                                                    <input type="text" name="price_in_call" id="Weekend_in_call" maxlength="6" value="" />
                                                                                </td>
                                                                                <td><input type="text" name="price_out_call" id="Weekend_out_call" maxlength="6" value="" /></td>
                                                                                <td>
                                                                                    <div class="config-group">
                                                                                        <div class="group">
                                                                                            <div class="button-box autoplay column-2">
                                                                                                <input type="hidden" id="currency_name_9" name="curency" value="EUR"/> 
                                                                                                <a class="table-bt" href="javascript:void(0)" style="display:block; width:auto;" onclick = "submit_incall_outcall_category_form('Weekend')" >Save</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
