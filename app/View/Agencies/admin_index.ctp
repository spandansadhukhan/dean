           ...
           <?php echo $this->Form->input("advace_search_type",array('type'=>'hidden','value'=>0))?>
            <div class="table-options clearfix" style=" background-color:#fff">
				...
				<div class="btn-group btn-group-sm pull-right">
					<a id="style-hover" class="btn btn-primary gap_up gap_up_down" title="" data-toggle="tooltip" href="<?php echo $this->webroot;?>admin/users/addagency" data-original-title="Add New Agency">Add New</a>
				</div>
		</div>
...
<!--                <td class="text-center">
          ...
          <?php } ?>
                                        ...
                                        <a href="javascript:void(0);" onclick="edit(<?php echo $user['User']['id'];?>)" class="btn btn-info enable-tooltip" data-original-title="Manage Account"><i class="fa fa-sign-in"></i></a>
                                        <!--fa fa-life-bouy-->
                                    </div>
                                </td>
...
function active(aa) {
        ...
        if (a)
        {
            location.href = "<?php echo $this->webroot?>admin/users/agentactive/" + aa;
        }
    }
