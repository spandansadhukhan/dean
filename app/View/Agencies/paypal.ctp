            ...
            <div class="title-section">
                <div class="row">
                    <div class="small-12 columns">
                        ...
                        <input type="hidden" name="notify_url" value="<?php echo $site_url;?>ipnagent.php">
                        ...
                        <input type="hidden" name="return" value="<?php echo $site_url;?>agencies/success">
                        <input type="hidden" name="cancel_return" value="<?php echo $site_url;?>agencies/failure">
