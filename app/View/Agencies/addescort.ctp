			...
			<div class="row">
				...
				<div class="col-lg-9">
					<div class="acntSetting p-1">
						<h2 class="font-weight-normal">Manage Escorts</h2>
					</div>
					<ul class="nav nav-tabs mt-4 tabParts">
					  <li class="active"><a data-toggle="tab" href="#home">Manage Escorts</a></li>
					  <li ><a data-toggle="tab" href="#menu1">Add Escort</a></li>
					</ul>
					<div class="tab-content">
					  ...
					  <div id="menu1" class="tab-pane ">
					  	...
					  	<div class="mt-3 mb-3 jobHeading">
                                                     <form action="<?php echo $this->webroot ?>agencies/addescort" method="post" accept-charset="utf-8" class="ajaxform"  enctype="multipart/form-data"> 
					  		<h2>Add Escort</h2>
