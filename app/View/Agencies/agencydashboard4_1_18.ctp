                                    ...
                                    <section class="all-pins-do">
                                        <div class="my-account-inner"><div class="sb-toggle-right navbar-right">
                                            ...
                                            <div class="left-my-account-menu-m">
                                                ...
                                                <?php
echo $this->element('agent_sidebar');
?>
                                                ...
                                                <div class="right-my-account-blocks">
                                                    <div class="detail-heading">
                                                        ...
                                                        <section class="title-left">
                                                            <h1 style="display:inline-block;"> My The Directory Home</h1>
                                                                ...
                                                                <div class="modal fade" id="userProfileImage" style="" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content" id="addrEditModal">
                                                                            <form action="<?php
echo $this->webroot;
?>users/agencydashboard" method="post" enctype="multipart/form-data">
...
?>" />
                                                        ...
                                                        <section class="profile-info">
                                                            <a href="javascript:void(0)" class="r_butt edi_pro" style="text-align: center;width: 100px;" onclick="location.href='<?php
echo $this->webroot;
?>agencies/editagentprofile'"> Edit Your Profile </a>
                                                            <a href="javascript:void(0)" class="r_butt" style="margin-top:33px; text-align: center;width: 100px;">Advertise With Us</a>
                                                            <a href="javascript:void(0)" class="r_butt" style="margin-top:66px; text-align: center;width: 100px;" 
                                                            onclick="location.href='<?php
echo $this->webroot;
?>agencies/postbanner'">Home Page Banner Ad </a>
                                                            <ul>
...
?> </span>
                                                                ...
                                                                <li><span class="s-left1">Account Status :</span><span class="s-right">Not Approved (Your profile not publish and listed on The Directory )</span>
                                                                    <section class="clr"></section>
                                                                </li>
                                                            </ul>
                                                            <div class="statu">
...
<dt>
    Upload Agency/Club Photos </dt>
    <dd>
                   up to <?php echo $permissions->uploadphotos?> Photos          </dd>
    
    <dt>
        Add Escort Profiles 
    </dt>
    <dd><?php echo $permissions->add_escort_profile==-1?'Unlimited':$permissions->add_escort_profile?></dd>

        <dt>
    Upload Videos  </dt>
    <dd><?php echo $permissions->upload_video?'Second Videos per Escort':"No"?></dd>
<dt>
    Agency Profile Description</dt>
    <dd><?php echo $permissions->my_profile?> characters</dd>

<dt>
    Customer Blacklist</dt>
    <dd><?php echo $permissions->customer_blacklist?"Yes":"No"?></dd>
    <dt>
    Web Site Booking Feature </dt>
    <dd><?php echo !empty($permissions->direct_booking)?"Yes":"No";?></dd>

    <dt>
    Priority Profile Listing </dt>
    <dd><?php echo $permissions->prioritylisting?"Yes":"No"?></dd>
    ...
    <dd><?php echo $permissions->contact_info?"Yes":"No"?></dd>
    
    <dt>
    Company Website </dt>
    <dd><?php echo $permissions->own_website?"Yes":"No"?></dd>
    <dt>
    Upcoming Events </dt>
    <dd><?php echo $permissions->upcomeing_event?"Yes":"No"?></dd>
    <dt>
    Free Email Account </dt>
    <dd><?php echo !empty($permissions->free_email)?"Yes":"No"?></dd>
    <dt>
    Manage Online Shop </dt>
    <dd><?php echo $permissions->onlineshop?"Yes":"No"?></dd>
    <dt>
    Banner Advertising </dt>
    <dd><?php echo !empty($permissions->post_add)?"Yes":"No"?></dd>
    <dt>
    Blog Feature </dt>
    ...
    <dt>
    Place Adult Job Ads </dt>
    <dd><?php echo !empty($permissions->place_adult)?"Yes":"No"?></dd>
    <dt>
