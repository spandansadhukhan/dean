                                                ...
                                                <div class="right-my-account-blocks">
                                                    <div class="detail-heading">
                                                        ...
                                                        <section class="title-left">
                                                            <h1 style="display:inline-block;"> The Directory Home</h1>
                                                    ...
                                                    <div class="right-my-account-blocks-inner">
                                                                ...
                                                                <div class="modal fade" id="userProfileImage" style="" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content" id="addrEditModal">
                                                                            <form action="<?php echo $this->webroot; ?>users/agencydashboard" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <section class="profile-info">
                                                            <a href="javascript:void(0)" class="r_butt edi_pro" style="text-align: center;width: 100px;"> Add New Profile </a>
