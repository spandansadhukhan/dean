                ...
                <section id="middle">
                    ...
                    <div class="triangleBottomRight firstItem"></div>
                        ...
                        <div class="acntSetting p-1">
                                                    <h2 class="font-weight-normal">Set Rates & Tariff</h2>
                        </div>
                        </section>
                        <div class="clr"></div>
                        </div>
                        ...
                        <tbody>
                                	<?php 
                                		...
                                		<tr>
                                			...
                                			<td>
                                                       <a href="<?php echo $this->webroot?>agencies/setprice/<?php echo base64_encode($showmodel['User']['id']); ?>" class="btn btn-primary">Set Price</a>
