        ...
        <div class="col-sm-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    Blacklist Customers (Total Records: <?php echo $total_category; ?>)
                </header>
                        ...
                        <tbody>
                            <?php foreach ($users as $user): ?>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td><?php echo h($user['Blacklist']['id']); ?>&nbsp;</td>                                                <td><?php echo h($user['User']['name']); ?>&nbsp;</td>
                                    <td><img src="<?php echo $this->webroot;?>user_images/<?php echo h($user['User']['profile_image']); ?>" height="100px" width="100px">&nbsp;</td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">  
                                            ...
                                            <a href="javascript:void(0);" onclick="viewdata(<?php echo $user['Blacklist']['id']; ?>)" class="btn btn-default enable-tooltip view-record" data-original-title="View Record"><i class="fa fa-search"></i></a>

                                            <?php if ($user['Blacklist']['status'] == 1) { ?>
                                                <a href="javascript:void(0);"  onclick="active(<?php echo $user['Blacklist']['id']; ?>)" class="btn btn-success enable-tooltip" data-original-title="Inactive Record"><i class="fa fa-circle-o"></i></a>

                                            <?php } else if ($user['Blacklist']['status'] == 0) { ?>
                                                <a href="javascript:void(0);" onclick="Inactive(<?php echo $user['Blacklist']['id']; ?>)" class="btn btn-warning enable-tooltip" data-original-title="Inactive Record"><i class="fa fa-circle-o"></i></a>
                                            <?php } ?>

                                            <a href="javascript:void(0);" onclick="del(<?php echo $user['Blacklist']['id']; ?>)" class="btn btn-danger enable-tooltip" data-original-title="Delete Record"><i class="fa fa-times"></i></a>
...
<?php } ?>
    ...
    function del(aa) {
        ...
        if (a == true)
        {
            location.href = "<?php echo $this->webroot ?>admin/escorts/deleteblack/" + aa;
        } else {
            location.href = "<?php echo $this->webroot ?>admin/escorts/blacklist";
        }
    }
    ...
    function active(aa) {
        ...
        if (a)
        {
            location.href = "<?php echo $this->webroot ?>admin/escorts/activeblacklist/" + aa;
        }
    }
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Blacklisted user Detail</h4>
            </div>
