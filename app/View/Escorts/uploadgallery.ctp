                                                                ...
                                                                <div class="form-profile">
                                                                    <div class="smart-wrap">
                                                                      ...
                                                                      enctype="multipart/form-data" accept-charset="utf-8" class="ajaxform" id="form-ui">
                                                                                <input type="hidden" name="data[Moreimage][id]" value="<?php echo !empty($this->request->data["Moreimage"]["id"])?$this->request->data["Moreimage"]["id"]:"" ?>">
                                                                                <input type="hidden" name="data[Moreimage][hide_image]" value="<?php echo !empty($this->request->data["Moreimage"]["image"])?$this->request->data["Moreimage"]["image"]:"" ?>">
                                                                                ...
                                                                                <div class="form-profile-block">
                                                                                    ...
                                                                                    <div class="inputContainer">
                                                                                        <div class="section" style="">
                                                                                            <label class="field">
                                                                                                <input type="text" id="last_name" required="required" name="data[Moreimage][title]" value="<?php echo !empty($this->request->data['Moreimage']['title'])?$this->request->data['Moreimage']['title']:'' ?>" maxlength="100" class="gui-input">
                                                                                            </label>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
...
<!--                                                                                <div class="form-profile-block">
                                                                                    ...
                                                                                    <div class="inputContainer">
                                                                                        <div class="section">
                                                                                            <label class="field prepend-icon">
                                                                                                <textarea name="data[Moreimage][descriptions]" class="" required style=" height:162px; width:561px;">
                                                                                ...
                                                                                <div class="form-profile-block" style=" width:80%;">
                                                                                    ...
                                                                                    <div class="inputContainer">
                                                                                        <div class="section">
                                                                                            ...
                                                                                            <input type="file" name="data[Moreimage][image]"  class="upload" id="imgInp" onchange="readURL(this)"  />
                                                                                ...
                                                                                <div class="form-profile-block">
                                                                                    ...
                                                                                    <div class="inputContainer">
                                                                                        <div class="section">
                                                                                            <label class="field prepend-icon">
                                                                                                <img id="blah" alt="" style=" border: 1px " width="100" height="100" src="<?php echo !empty($this->request->data["Moreimage"]["image"])?$this->webroot.'user_webimages/'.$this->request->data["Moreimage"]["image"]:'' ?>" />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
