                                            ...
                                            <div class="right-my-account-blocks">
                                                <div class="detail-heading">
                                                    <section class="title-left">
                                                        <h1 style="display:inline-block;">My Private gallery</h1>
                                                    </section>
                                                    <div class="clr"></div>
                                                </div>
                                                        ...
                                                        <section class="content-box nre-span">
                                                            <section class="upc clear">
                                                                <form action="" method="post" accept-charset="utf-8" class="" id="form1" 
                                                                    ...
                                                                    <p id="termsandcond"><input type="checkbox" name="agree" value="0" id="terms">I have read and understand these Terms and Conditions</p>
                                                                    <br/>
                                                                     <input type="checkbox" name="" value="0" onclick="already_understand();">Don’t Show me this as I have read and understand these Terms and Conditions
                                                                </form>                
                                                            </section>
                                                            <div class="clear"></div>
                                                 ...
                                                 <section class="content-inner-box">
                                                    <section class="dashborad">
                                                        <section class="title-part">
                                                            <div class="detail-heading">
                                                                <section class="title-left">
                                                                    <h1 style="display:inline-block;">Upload Videos</h1>
                                                                </section>
                                                                <div class="clr"></div>
                                                            </div>
                                                            <section class="clr"></section>
                                                            ...
                                                            <section class="upc clear">
                                                                <form action="" method="post" accept-charset="utf-8" class="" id="form1" 
                                                                   ...
                                                                   <!--  <section>
                                                                    ...
                                                                    <p id="termsandcond"><input type="checkbox" name="agree" value="0" id="terms" required>I have read and understand these Terms and Conditions</p>
                                                                    <br/>
                                                                     <input type="checkbox" name="" value="0" onclick="already_understand();">Don’t Show me this as I have read and understand these Terms and Conditions
                                                                </form>                
                                                            </section>
