                            ...
                            <div class="right-my-account-blocks">
                                <div class="detail-heading">
                                    <section class="title-left" style="float: none;">
                                        ...
                                        &nbsp;
                                        <select id="site_currency" name="site_currency" class="form-control" size="1" onchange="getvalue(this.value)" style="float: right; width: auto;">
                                            <!--
                                                                    ...
                                                                    <input type="hidden" name="uid" value="<?php echo $user['Escort']['id']?>" />                                                                        
                                                                        <table>	
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <input type="text" name="30min_incall" id="30min_incall" maxlength="6" value="<?php echo $user['Rate']['30min_incall'] ?>" />
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" name="30min_outcall" id="30min_outcall" maxlength="6" value="<?php echo $user['Rate']['30min_outcall'] ?>" />
                                                                                </td>
...
<input class="table-bt" style="display:block; width:auto;" type="submit" name="submit" value="Update" >
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
