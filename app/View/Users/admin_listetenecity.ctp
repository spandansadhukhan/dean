            ...
            <section class="panel">
                ...
                <div class="adv-table col-sm-12">
                    ...
                    <table  class="display table table-bordered table-striped">
                        ...
                        <tbody>
	                <?php foreach ($etenecities as $user): ?>
                            <tr class="gradeX">
                                <td><?php echo $user['Ethnicitie']['id']; ?>&nbsp;</td>
                                <td><?php echo $user['Ethnicitie']['name']; ?>&nbsp;</td>

                                <td><?php echo $this->Html->link(__('Edit'), array('action' => 'editetenecity', $user['Ethnicitie']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'deleteetenecity', $user['Ethnicitie']['id']), null, __('Are you sure you want to delete # %s?', $user['Ethnicitie']['id'])); ?>

                                  <?php if($user['Ethnicitie']['is_active']=='1')
                                  {
                                  echo $this->Html->link(__('Deactive'), array('action' => 'activeetenecty', $user['Ethnicitie']['id'],0));
                                  }
                                  else {
                                  echo $this->Html->link(__('Active'), array('action' => 'activeetenecty', $user['Ethnicitie']['id'],1));
                                  }
                                ?>
                                </td>
