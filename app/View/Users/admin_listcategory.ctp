            ...
            <section class="panel">
                ...
                <div class="adv-table col-sm-12">
	                ...
	                <?php foreach ($categoriesescort as $user): ?>
                            <tr class="gradeX">
                                <td><?php echo $user['Category']['id']; ?>&nbsp;</td>
                                <td><?php echo $user['Category']['name']; ?>&nbsp;</td>

                                <td><?php echo $this->Html->link(__('Edit'), array('action' => 'editcategory', $user['Category']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'deletecategory', $user['Category']['id']), null, __('Are you sure you want to delete # %s?', $user['Category']['id'])); ?>

                                  <?php //if($user['Category']['active']=='1')
//                                  {
//                                  echo $this->Html->link(__('Deactive'), array('action' => 'activecategory', $user['Category']['id'],0));
//                                  }
//                                  else {
//                                  echo $this->Html->link(__('Active'), array('action' => 'activecategory', $user['Category']['id'],1));
//                                  }
//                                ?>
                                </td>
