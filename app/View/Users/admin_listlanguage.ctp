            ...
            <section class="panel">
                ...
                <div class="adv-table col-sm-12">
	                ...
	                <?php foreach ($languages as $user): ?>
                            <tr class="gradeX">
                                <td><?php echo $user['Language']['id']; ?>&nbsp;</td>
                                <td><?php echo $user['Language']['name']; ?>&nbsp;</td>

                                <td><?php echo $this->Html->link(__('Edit'), array('action' => 'editlanguage', $user['Language']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'deletelanguage', $user['Language']['id']), null, __('Are you sure you want to delete # %s?', $user['Language']['id'])); ?>

                                  <?php if($user['Language']['is_active']=='1')
                                  {
                                  echo $this->Html->link(__('Deactive'), array('action' => 'activelanguage', $user['Language']['id'],0));
                                  }
                                  else {
                                  echo $this->Html->link(__('Active'), array('action' => 'activelanguage', $user['Language']['id'],1));
                                  }
                                ?>
                                </td>
