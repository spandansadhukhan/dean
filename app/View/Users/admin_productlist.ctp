            ...
            <section class="panel">
                ...
                <div class="adv-table col-sm-12">
	                ...
	                <?php foreach ($allproducts as $user): ?>
                            <tr class="gradeX">
                                <td><?php echo $user['Product']['id']; ?>&nbsp;</td>
                                <td><?php echo $user['Product']['name']; ?>&nbsp;</td>
                                <td>$<?php echo $user['Product']['price']; ?>&nbsp;</td>
                                <td><?php echo $user['Product']['quan']; ?>&nbsp;</td>

                                <td><?php echo $this->Html->link(__('Edit'), array('action' => 'editproduct', $user['Product']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'deleteproduct', $user['Product']['id']), null, __('Are you sure you want to delete # %s?', $user['Product']['id'])); ?>

                                    <?php echo $this->Html->link(__('Upload Image'), array('action' => 'uploadimage', $user['Product']['id'])); ?>
