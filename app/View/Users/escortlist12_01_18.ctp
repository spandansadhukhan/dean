...
<?php echo $this->element('carousel_slider');?>
   <!--  <div id="wait-div" class="wait-div">
		...
		<ul>
			...
			<li style="width:9%">
                            <?php echo $this->Form->input("gender", array('options'=>$genders,'div'=>false,'label' => false));?>                                                      
			</li>
                        <li style="width:9%">
		...
		<ul>
			...
			<li style="width:8%">
                        ...
                        <li style="width:8%">
                            <button type="button" class="btn btn-default" onclick="location.href='<?php echo $this->webroot;?>users/escortlist/<?php echo $type;?>'">Clear</button>
			</li>
		</ul>
	</div>
            ...
            <div class="col-right" style="float:left;width:200px;margin-right:3px">
                ...
                <section class="side-1 extra_search_section">
                   ...
                   <div class="category_boxx">
                       ...
                       <a href="<?php echo $this->Html->url('/');?>users/escortlist/<?php echo $type;?>/<?php echo base64_encode($cat['Category']['id']);?>">
                           <?php echo $cat['Category']['name'];?>(<?php echo $cat['Category']['count']?>)</a>
                       <?php }?>
                                                ...
                                                <div class="pin_d_inner">
                                                    ...
                                                    <div class="overlay-pic">
                                                        <div class="country_box">
                                                            ...
                                                            <span><?php echo $lists["Location"]["name"]; ?></span>
                                                        </div>
