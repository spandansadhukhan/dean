...
<div class="wrapper">
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading"> Add Membership Feature name </header>
                <div class="panel-body">
                    <div class="form"> <?php echo $this->Form->create('Membershipattrbute',array('enctype'=>'multipart/form-data','class'=>'cmxform form-horizontal adminex-form')); ?>
