...
<ul class="side-menu">
    ...
    <li style="top: 100%;"> <a href="<?php echo $this->Html->url('/');?>faq">FAQ</a>
        <ul>
            ...
            <li style="top: 100%;"> <a href="<?php echo $this->Html->url('/');?>general-faq">ESCORT FAQs</a> </li>
        </ul>
    </li>
	  ...
	  <div class="carousel-inner" role="listbox">
		...
		<ul>
			...
			<li style="width:13%">				
                        ...
                        <li style="width:13%">				
                        <?php echo $this->Form->input("nationality_id", array('options'=>$nationalities,'empty'=>'Ethnicity','div'=>false,'label' => false));?>                                                      
			</li>
...
<!--               <script>
    ...
    <div class="col-left" style=" width:800px;">
        <section id="wrapper">
            <section id="middle">
                <!-- Escort Left start ---->
                    ...
                    <section class="all-pins-do">
                        <section id="searchResult" class="maintitle">
                        	<div class="full_title_form">
                                    <h1 style="height: 30px;" class="brows_box"> <span style="width: 60%; float:left;">Browse Escorts</span><form method="POST" action="">
                                            <input type="text" name="user_name" value="" style="float:right;" placeholder="Search by Name" id="user_name">
                                ...
                                <div id="container" class="transitions-enabled centered clearfix">
                                    <div id="display_result">    
                                      ...
                                      //pr($escorts); exit;
                                        ...
                                        ?>
                                        <div class="pin_d box online-girl" style="cursor:pointer;margin:15px 2px; width:24.15%;  background: url('<?php echo  $this->webroot; ?>user_images/<?php echo $showescortsdata['User']['profile_image'];?>'); " onclick="redirect_detaiils('<?php echo base64_encode($showescortsdata['User']['id']);?>');">
                                    
                                    <?php } 
                                    else { ?>
                                            <div class="pin_d box online-girl" style="cursor:pointer;margin:15px 2px; width:24.15%;background: url('<?php echo  $this->webroot; ?>noimage.png')" onclick="redirect_detaiils('<?php echo base64_encode($showescortsdata['User']['id']);?>')">
                                    <?php } ?>
						...
						<div class="pin_d box online-girl escort-of-day" style="margin:0;height:350px;width:99%; background: url('/newver/user_images/profile_img_53.jpg'); margin-bottom:20px">
                               <div class="pin_d_inner">
                                ...
                                <div class="all-c-badge">
                                    ...
                                    <img src="/newver/images/verified.png" title="Verified" alt="">
                                    <img src="/newver/images/video-ic.png" title="Videos" alt="">
                                    <img src="/newver/images/online.png" title="Online" alt="">
                                
                                </div> 
                                </a>   
                                <div class="overlay-pic">
                                	<div class="country_box">
                                		<img alt="Escorts" src="/newver/images/en-flag.png" width="30px" height="autoo">
                                		<span>Waimate</span>
                                	</div>
                                    <div class="overlay-pic-inner">
                                        <h3> <span style="float:left;">
                        ...
                        <!--<div id="cityList1" class="leftbg scroll-wrapper1 extra_search_cityList1">
                            ...
                            <ul class="feature_box">
                                ...
                                foreach ($showfeature as $showfeatured) {
                             	...
                             	?>  
								<li><a href="<?php echo $this->webroot?>escort-details/<?php echo base64_encode($showfeatured['User']['id']);?>" target="_blank">
                                                                        <img  src="<?php echo $this->webroot?>user_images/<?php echo $showfeatured['User']['profile_image'];?>" style=" height:100px;width:100px;"></a></li>
								<?php }
								?>
							</ul>
							<br/>
