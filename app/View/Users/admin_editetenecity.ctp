...
<div class="wrapper">
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading"> Add Ethnicitie </header>
                <div class="panel-body">
                    <div class="form"> <?php echo $this->Form->create('Ethnicitie',array('enctype'=>'multipart/form-data','class'=>'cmxform form-horizontal adminex-form')); ?>
