            ...
            <section class="panel">
                ...
                <div class="adv-table col-sm-12">
	                ...
	                <?php foreach ($users as $user): ?>
                            <tr class="gradeX">
                                <td><?php echo $user['Membership']['id']; ?>&nbsp;</td>
                                <td><?php echo $user['Membership']['name']; ?>&nbsp;</td>		
                                <td><?php echo $user['Membership']['duration']; ?>&nbsp; Days</td> 
                                <td>$<?php echo $user['Membership']['price']; ?>&nbsp;</td>
                                <td><?php if($user['Membership']['is_active']==1) {echo 'Active';} else { echo 'Inactive';} ?>&nbsp;</td>


                                <td class="text-center">
                                    
                                    <a href="<?php echo $this->webroot?>admin/users/membership_feature/<?php echo $user['Membership']['id']; ?>">Add membership Features</a>
                                    <div class="btn-group btn-group-sm">  

          <?php if($user['Membership']['is_active']==1) { ?>
                                        <a href="javascript:void(0);"  onclick="active(<?php echo $user['Membership']['id'];?>)" class="btn btn-success enable-tooltip" data-original-title="Inactive Record"><i class="fa fa-circle-o"></i></a>

          <?php } if($user['Membership']['is_active']==0){ ?>
                                        <a href="javascript:void(0);" onclick="Inactive(<?php echo $user['Membership']['id'];?>)" class="btn btn-warning enable-tooltip" data-original-title="Inactive Record"><i class="fa fa-circle-o"></i></a>
          <?php } ?>
