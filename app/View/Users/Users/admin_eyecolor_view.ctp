                ...
                <div class="col-lg-12">
				   ...
				   <div class="row">
					<div class="col-sm-2"><strong>Id</strong></div>
                                        <div class="col-sm-10"><?php echo h($colors['Eyecolor']['id']); ?> </div>
                                    </div>
					<div class="clearfix"></div>
				    <div class="row">
					<div class="col-sm-2"><strong>Color Name</strong></div>
                                        <div class="col-sm-10"><?php echo h($colors['Eyecolor']['color_name']); ?></div>
                                    </div>
				
				<div class="clearfix"></div>
				    <div class="row">
					<div class="col-sm-2"><strong>Active</strong></div>
                                        <div class="col-sm-10"><?php echo h($colors['Eyecolor']['is_active']==1?'Yes':'No'); ?></div>
                                    </div>
				 <div class="clearfix"></div>
