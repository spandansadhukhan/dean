               ...
               // echo $this->Form->input('id');
                ?>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            /
					<?php echo $this->Form->input('first_name',array('label'=>false,'required'=>'required','class'=>'form-control')); ?>
                                        </div>
                                    </div>
                                    <div class="form-group ">
					    ...
					    <?php echo $this->Form->input('username',array('label'=>false,'class'=>'form-control')); ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
					<?php echo $this->Form->input('password',array('label'=>false,'class'=>'form-control','value'=>'')); ?>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="email" class="control-label col-lg-2">Email</label>
                                        <div class="col-lg-10">
                                          <?php echo $this->Form->input('email',array('label'=>false,'required'=>'required','class'=>'form-control','type'=>'email')); ?>
                                        </div>
                                    </div>

                                      <div class="form-group ">
                                        <label for="email" class="control-label col-lg-2">Contact No</label>
                                        <div class="col-lg-10">
                                          <?php echo $this->Form->input('phone_no',array('label'=>false,'required'=>'required','class'=>'form-control','id'=>'contact_no','onchange' => "javascript:number();")); ?>
                                        </div>
                                    </div>
                    ...
                    echo $this->Form->input('gender',array('label'=>false,'required'=>'required','class'=>'form-control','options'=>$options,'empty'=>'--Select--')); ?>
                                        </div>
                                    </div>
				    ...
				    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                          <?php  echo $this->Form->input('country_id',array('label'=>false,'required'=>'required','class'=>'form-control','options'=>$countries,'empty'=>'--Select Country--')); ?>
					...
					<?php  echo $this->Form->input('city',array('label'=>false,'required'=>'required','class'=>'form-control')); ?>
