...
<section id="contentsection">
	...
	<div class="searchbar">
		<ul>
            ...
            <form method="POST" action="<?php echo $this->webroot?>users/index">
			<li style="width:15%">
				<select name="country" id="cuntr">
                    <option value="">Select country</option>
                    <?php foreach ($showcountry as $getcountry) { ?>
                     <option value="<?php echo $getcountry['Country']['id']?>" <?php if(isset($this->request->data['Country'])){if($this->request->data['Country']==$getcountry['Country']['id']){echo "selected";}}?>><?php echo $getcountry['Country']['name']?>  
                    <?php }?>
                </select>
			</li>
            <script>
            $(document).ready(function () {
                        $('#cuntr').onChange(function(){ alert(); });
                    });
                    </script>
			<li style="width:13%">
				<select name="state">
                    ...
                    <?php 
                         foreach ($locationsarray as $showlocations) {
                                
                    ?>
                    <option value="<?php echo $showlocations['Location']['id']?>" <?php if(isset($this->request->data['state'])){if($this->request->data['state']==$showlocations['Location']['id']){echo "selected";}}?>><?php echo $showlocations['Location']['name']?></option>
                    <?php } ?>
                </select>
			</li>
            <li style="width:9%">
                <select name="age">
                    ...
                    ?>
                    <option vakue="<?php echo $age;?>" <?php if(isset($this->request->data['age'])){if($this->request->data['age']==$age){echo "selected";}}?>><?php echo $age;?></option>
                    <?php } ?>
                </select>
            </li>
			...
			<li style="width:9%">
				<select name="gender">
					<option value="">Gender</option>
			      	<option value="M" <?php if(isset($this->request->data['gender'])){if($this->request->data['gender']=='M'){echo "selected";}}?>>Male</option>
			      	<option value="F" <?php if(isset($this->request->data['gender'])){if($this->request->data['gender']=='F'){echo "selected";}}?>>Female</option>
			      	<option value="T" <?php if(isset($this->request->data['gender'])){if($this->request->data['gender']=='T'){echo "selected";}}?>>Trans</option>
				</select>
			</li>
			<li style="width:8%">
                    ...
                    <section class="all-pins-do">
                        <section id="searchResult" class="maintitle">
                            ...
                            <div class="checkbox_search">
                            	<ul>
									<li><input type="checkbox" /> <span>VIE</span></li>
									<li><input type="checkbox" /> <span>Premium</span></li>
									<li><input type="checkbox" /> <span>Verified</span></li>
									<li><input type="checkbox" /> <span>GFE</span></li>
									<li><input type="checkbox" /> <span>Pornstar</span></li>
									<li><input type="checkbox" /> <span>With Video</span></li>
									<li><input type="checkbox" /> <span>Online</span></li>
								</ul>
                            </div>
    ...
    <div class="col-right">
		...
		<section class="side-1 extra_search_section">
           ...
           <a href="<?php echo $this->Html->url('/');?>users/index/<?php echo base64_encode($cat['Category']['id']);?>"><?php echo $cat['Category']['name'];?>(<?php echo $cat['Category']['count'];?>)</a>
           <?php }} ?>
				<!--<a href="">TV/TS (4)</a>
                        ...
                        <!--<div id="cityList1" class="leftbg scroll-wrapper1 extra_search_cityList1">
                            ...
                            <ul class="feature_box">
                                ...
                                foreach ($showfeature as $showfeatured) {
                             	...
                             	?>  
								<li><img  src="<?php echo $this->webroot?>user_images/<?php echo $showfeatured['User']['profile_image'];?>"></li>
								<?php }
								?>
							</ul>
                    </section>
