              ...
              <tr class="gradeX">
                ...
                <td class="text-center">
                   ...
                   <div class="btn-group btn-group-sm">  
                                        ...
                                        <a href="<?php echo $this->webroot;?>admin/users/editsubadmin/<?php echo $user['User']['id']; ?>" class="btn btn-info enable-tooltip" data-original-title="Manage Account"><i class="fa fa-sign-in"></i></a>
...
function del(aa) {
        ...
        if (a)
        {
            location.href = "<?php echo $this->webroot?>admin/users/subadmindelete/" + aa;
        }
    }
    ...
    function active(aa) {
        ...
        if (a)
        {
            location.href = "<?php echo $this->webroot?>admin/users/subadminactive/" + aa;
        }
    }
