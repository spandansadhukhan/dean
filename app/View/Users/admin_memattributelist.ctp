            ...
            <section class="panel">
                ...
                <div class="adv-table col-sm-12">
                    ...
                    <table  class="display table table-bordered table-striped">
                        ...
                        <tbody>
	                <?php foreach ($categoriesescort as $user): ?>
                            <tr class="gradeX">
                                <td><?php echo $user['Membershipattrbute']['id']; ?>&nbsp;</td>
                                <td><?php echo $user['Membershipattrbute']['name']; ?>&nbsp;</td>

                                <td><?php echo $this->Html->link(__('Edit'), array('action' => 'editmemattribute', $user['Membershipattrbute']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'deletememattribute', $user['Membershipattrbute']['id']), null, __('Are you sure you want to delete # %s?', $user['Membershipattrbute']['id'])); ?>

                                  <?php 
                                  /*
                                  if($user['Membershipattrbute']['is_active']=='1')
                                  {
                                  echo $this->Html->link(__('Deactive'), array('action' => 'activecategory', $user['Membershipattrbute']['id'],0));
                                  }
                                  else {
                                  echo $this->Html->link(__('Active'), array('action' => 'activecategory', $user['Membershipattrbute']['id'],1));
                                  }
                                  */
                                ?>
                                </td>
