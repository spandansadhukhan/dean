                            ...
                            <section id="middle">
                                <section id="middle-inner">
                                    ...
                                    <section class="all-pins-do">
                                        <h2 class="title">Classified Ads</h2>
                                        <div class="in-content">
                                            <section class="dt-content-blogs  clas-fhyt-fhty">
                                                <article class="post clearfix">
                                                    <span class="post-thumbnail pull-left rounded">
                                                        <img alt="" src="images/o_1a3gpn5sr2je13u4fmk18a9oc2a1447133392-400x575.jpg">
                                                    </span>
...
<!--    <span class="cat-links last"> in <a rel="category tag" title="View all posts in Events" href="#" style="outline: medium none;">Events</a></span>  -->
                                                    ...
                                                    <div class="entry-content">
                                                        ...
                                                        <p class="blog_description_div">afsdaf asfdasf</p>
                                                    </div>
                                                    <section class="entry-meta clearfix">
                                                        <a class="btn btn-small btn-transparent" href="design-your-adult-site.html" style="outline: medium none;"><span>View detail</span></a>
                                                    <!--    <a class="comments-link" href="javascript:void(0);" style="outline: medium none;"><span> Comments</span></a>  -->
                                                    </section>
                                                    <section class="clr"></section>
                                                </article>
                                                <article class="post clearfix">
                                                    <span class="post-thumbnail pull-right rounded">
                                                        <img alt="" src="<?php echo  $this->Html->url('/') ?>images/o_1a3gpn5sr2je13u4fmk18a9oc2a1447133392-400x575.jpg">
                                                    </span>
                                                    <div class="entry-meta">
                                                                                    <!--    <span class="entry-date" style="border:none">Location : United Kingdom,Bristol</span>  -->
...
<!--    <span class="cat-links last"> in <a rel="category tag" title="View all posts in Events" href="#" style="outline: medium none;">Events</a></span>  -->
                                                    ...
                                                    <div class="entry-content">
                                                        <h2 class="entry-title"><a href="javascript:void(0);" style="outline: medium none;">Design your adult site</a></h2>
                                                        <span class="entry-date" style="border:none;color:#b225b5">Location : New Zealand,Orewa</span><br/>
                                                        <p class="blog_description_div">Design your adult site</p>
                                                    </div>
                                                    <section class="entry-meta clearfix">
                                                        <a class="btn btn-small btn-transparent" href="javascript:void(0);" style="outline: medium none;"><span>View detail</span></a>
                                                    <!--    <a class="comments-link" href="javascript:void(0);" style="outline: medium none;"><span> Comments</span></a>  -->
                                                    </section>
                                                    <section class="clr"></section>
                                                </article>
                                            ...
                                            <script>
                                                function makesearchurl()
                                                {
                                                    ...
                                                    window.location = 'http://layout9.demoparlour.com/advdirectory/classified-search/' + key;
                                                }
                                            </script>
