...
<?php echo $this->element('carousel_slider');?>
    <div class="detail-heading" style="padding: 0 5px;"><h2 class="title">Online Escorts</h2></div>    
   ...
   <!--  <div id="wait-div" class="wait-div">
		...
		<ul>
			...
			<li style="width:8%">
                        ...
                        <li style="width:8%">
                            <button type="button" class="btn btn-default" onclick="location.href='<?php echo $this->webroot;?>online-escorts'">Clear</button>
			</li>
		</ul>
	</div>
       ...
       <div class="col-right" style="float:left;width:200px;margin-right:3px">
                ...
                <section class="side-1 extra_search_section">
                   ...
                   <div class="category_boxx">
                       ...
                       <a href="<?php echo $this->Html->url('/');?>online-escorts/<?php echo base64_encode($cat['Category']['id']);?>"><?php echo $cat['Category']['name'];?>(<?php echo $cat['Category']['count']?>)</a>
                       <?php }?>
...
function ajaxSearch()
{
    $.post("<?php echo $this->Html->url('/'); ?>users/ajax_searchonline", $("#SearchCheck, #SearchForm").serialize(), function(msg){
