...
<section id="blog-details">
  <section id="middle" class="middle-parts" style="background: #fff;">
    <section id="middle-inner">
      <section class="all-pins-do">
        
         
                    <span style="float:right;border:none" class="mobile-none"> <a href="#" class="sign-bt">
          Back          </a> </span>
        <div class="in-content">
          <section class="dt-content-blogs" style="width: 100%;">
            ...
            <div class="row">
                ...
                ?>
                <img alt="" src="<?php echo $this->webroot ?>blog_images/<?php echo $blogdetails['Blog']['image']?>"  class="img-fluid"/>
                <?php }else{ ?>
