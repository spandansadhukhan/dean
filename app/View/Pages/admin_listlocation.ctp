            ...
            <section class="panel">
                ...
                <div class="adv-table col-sm-12">
	                ...
	                <?php foreach ($etenecities as $user): ?>
                            <tr class="gradeX">
                                <td><?php echo $user['Location']['id']; ?>&nbsp;</td>
                                <td><?php echo $user['Location']['name']; ?>&nbsp;</td>

                                <td><?php echo $this->Html->link(__('Edit'), array('action' => 'editlocation', $user['Location']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'deletelocation', $user['Location']['id']), null, __('Are you sure you want to delete # %s?', $user['Location']['id'])); ?>

                                  <?php if($user['Location']['is_active']=='1')
                                  {
                                  echo $this->Html->link(__('Deactive'), array('action' => 'activelocation', $user['Location']['id'],0));
                                  }
                                  else {
                                  echo $this->Html->link(__('Active'), array('action' => 'activelocation', $user['Location']['id'],1));
                                  }
                                ?>
                                </td>
