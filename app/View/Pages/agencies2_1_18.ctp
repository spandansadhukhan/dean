                    ...
                    <section class="all-pins-do">
                        ...
                        <section id="content" style="width:100%">
                            ...
                            <div style="position: relative;" id="container" class=""><?php 
                                if(!empty($allclubs)){
                                    foreach ($allclubs as $showclubs) {
                            ?>
                            
                                <div style="" class="pin_d box online-girl">
                                    <div class="pin_d_inner" style="background: url('<?php echo $this->webroot?>user_images/<?php echo $showclubs['User']['profile_image']?>') no-repeat center center; background-size: cover; ">
