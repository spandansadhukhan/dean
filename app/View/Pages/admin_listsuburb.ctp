                    ...
                    <table  class="display table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo 'Name'; ?></th>
                                <th><?php echo 'City/Region'; ?></th>
                                <th><?php echo 'Actions'; ?></th>

                            </tr>
                        </thead>
                        <tbody>
	                <?php foreach ($suburbs as $user): ?>
                            <tr class="gradeX">
                                <td><?php echo $user['Suburb']['id']; ?>&nbsp;</td>
                                <td><?php echo $user['Suburb']['name']; ?>&nbsp;</td>
                                <td><?php echo $user['Location']['name']; ?>&nbsp;</td>
                                <td><?php echo $this->Html->link(__('Edit'), array('action' => 'editsuburb', $user['Suburb']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'deleteSuburb', $user['Suburb']['id']), null, __('Are you sure you want to delete # %s?', $user['Suburb']['id'])); ?>

                                  <?php if($user['Suburb']['is_active']=='1')
                                  {
                                  echo $this->Html->link(__('Deactive'), array('action' => 'activeSuburb', $user['Suburb']['id'],0));
                                  }
                                  else {
                                  echo $this->Html->link(__('Active'), array('action' => 'activeSuburb', $user['Suburb']['id'],1));
                                  }
                                ?>
                                </td>
...
<?php } ?>
    ...
    function del(aa) {
        ...
        if (a)
        {
            Suburb.href = "<?php echo $this->webroot?>admin/users/userdelete/" + aa;
        }
    }
    ...
    function active(aa) {
        ...
        if (a)
        {
            Suburb.href = "<?php echo $this->webroot?>admin/users/packageactive/" + aa;
        }
    }
