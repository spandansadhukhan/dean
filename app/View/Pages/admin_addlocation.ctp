...
<div class="wrapper">
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading"> Add City/Region </header>
                <div class="panel-body">
                    ...
                    <div class="form"> <?php echo $this->Form->create('Location',array('enctype'=>'multipart/form-data','class'=>'cmxform form-horizontal adminex-form')); ?>
                        ...
                        <div class="form-group ">
                            <label for="name" class="control-label col-lg-2">Location Name <span style="color:red;">*</span></label>
                            <div class="col-lg-10"> <?php echo $this->Form->input('country_id',array('empty'=>'Select Country','label'=>false,'options'=>$locationsname,'required'=>'required','class'=>'form-control','placeholder'=>'Name')); ?> </div>
                        </div>
