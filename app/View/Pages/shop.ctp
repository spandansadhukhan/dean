	...
	<div class="container">
		<div class="row">
            ...
            ?>
							...
							<div class="middleImagePart agency-image" style="background:url(<?php echo $this->webroot ?>product_img/<?php echo $allproductsfrontend['Gettwoimage'][0]['image'] ?>) no-repeat;">
							</div>
							<div class="girlName mt-2 mb-2">
								<h2 class="text-uppercase text-center text-uppercase font-14"><?php echo $allproductsfrontend['Product']['name']; ?></h2>
							</div>
							<div class="girlAge text-center mt-2 mb-2">
								<p class="mb-0"> Price:
                        $<?php echo $allproductsfrontend['Product']['price']; ?>,</p>
							</div>
							<div class="bottomRate text-center mt-2 mb-2">
								<p>Quantity :- <?php echo $allproductsfrontend['Product']['quan']; ?></p>
                                                                <p>By :-Admin</p>
							</div>
