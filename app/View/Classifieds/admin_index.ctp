  ...
  <div class="wrapper">
    ...
    <div class="row gap_row">
      <div class="col-sm-12">
        ...
        <header class="panel-heading">
            Classified Ads (Total Records: <?php echo $total_category;?>)
        </header>
	...
	<tr class="gradeX">
		...
		<td><?php echo h($sl_no); ?>&nbsp;</td>
                ...
                <td><?php if($classified['Classified']['status']==1) {echo 'Active';} else { echo 'Inactive';} ?>&nbsp;</td>
                <td class="text-center">
                                    <div class="btn-group btn-group-sm">  

                                        <a href="javascript:void(0);" onclick="view(<?php echo  $classified['Classified']['id'];?>)" class="btn btn-default enable-tooltip view-record" data-original-title="View Record"><i class="fa fa-search"></i></a>

                                       
                                        <a href="javascript:void(0);" onclick="del(<?php echo  $classified['Classified']['id'];?>)" class="btn btn-danger enable-tooltip" data-original-title="Delete Record"><i class="fa fa-times"></i></a>

          <?php if($classified['Classified']['status']== 1){ ?>
                                        <a href="javascript:void(0);"  onclick="active(<?php echo  $classified['Classified']['id'];?>)" class="btn btn-success enable-tooltip" data-original-title="Inactive Record"><i class="fa fa-circle-o"></i></a>

          <?php } else if($classified['Classified']['status']== 0){ ?>
                                        <a href="javascript:void(0);" onclick="Inactive(<?php echo  $classified['Classified']['id'];?>)" class="btn btn-warning enable-tooltip" data-original-title="Inactive Record"><i class="fa fa-circle-o"></i></a>
          <?php } ?>
...
<?php } ?>
    ...
    function del(aa) {
        ...
        if (a)
        {
            location.href = "<?php echo $this->webroot?>admin/classifieds/deleteclassified/" + aa;
        }
    }
    ...
    function active(aa) {
        ...
        if (a)
        {
            location.href = "<?php echo $this->webroot?>admin/classifieds/activeclassified/" + aa ;
        }
    }
