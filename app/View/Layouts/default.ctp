...
<!--	                        <div class="ajax_report notification spacer-t5 form-msg">
	                    ...
	                    <div class="row">
	                        <div class="col-lg-6">
	                            ...
	                            <input type="email" placeholder="Email" class="form-control" required="required" name="email" id="logemail" maxlength="50" type="text">
	                        </div>
	                        <div class="col-lg-6">
	                        	<label>Password</label>
	                            <input placeholder="Password" name="password" id="logpassword" class="form-control" required="required" maxlength="50" type="password">
	                        </div>
	                    </div>
