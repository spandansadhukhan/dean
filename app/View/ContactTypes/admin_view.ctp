                ...
                <div class="col-lg-12">
				   ...
				   <div class="row">
					<div class="col-sm-2"><strong>Id</strong></div>
                                        <div class="col-sm-10"><?php echo h($services['Service']['id']); ?> </div>
                                    </div>
					<div class="clearfix"></div>
				    <div class="row">
					<div class="col-sm-2"><strong>Name</strong></div>
                                        <div class="col-sm-10"><?php echo h($services['Service']['name']); ?></div>
                                    </div>
				
				<div class="clearfix"></div>
				    <div class="row">
					<div class="col-sm-2"><strong>Active</strong></div>
                                        <div class="col-sm-10"><?php echo h($services['Service']['is_active']==1?'Yes':'No'); ?></div>
                                    </div>
				 <div class="clearfix"></div>
