  ...
  <div class="wrapper">
    <div class="row gap_row">
      <div class="col-sm-12">
        ...
        <header class="panel-heading">
            Clubs (Total Records: <?php echo $total_user;?>)
        </header>
           ...
           <?php echo $this->Form->input("advace_search_type",array('type'=>'hidden','value'=>0))?>
            <div class="table-options clearfix" style=" background-color:#fff">
				...
				<div class="btn-group btn-group-sm pull-right">
					<a id="style-hover" class="btn btn-primary gap_up gap_up_down" title="" data-toggle="tooltip" href="<?php echo $this->webroot;?>admin/users/addparlor" data-original-title="Add New Club">Add New</a>
				</div>
		</div>
    ...
    <td><?php if($user['User']['is_active']==1) {echo 'Active';} else { echo 'Inactive';} ?>&nbsp;</td>
		...
		<div class="btn-group btn-group-sm">
                    ...
                    <a href="<?php echo $this->webroot;?>admin/clubs/delete/<?php echo $user['User']['id']; ?>" onclick="del(<?php echo $user['User']['id'];?>)" class="btn btn-default enable-tooltip view-record btn btn-primary" data-original-title="View Record"><i class="fa fa-times" aria-hidden="true"></i></a>
...
function getViewUser(userid){
  //alert(userid);
	$.post('<?php echo($this->webroot)?>admin/clubs/view/'+userid,function(data){
