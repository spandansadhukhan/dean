				...
				<div class="col-lg-9">
					...
					<div class="tab-content">
					  <div id="home" class="tab-pane in active">
					      <table class="table table-hover">
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                 <a href="<?php echo $this->webroot; ?>parlors/blog_edit/<?php echo $blog['Blog']['id']; ?>">Edit</a>
                                                 <a href="<?php echo $this->webroot; ?>parlors/blog_delete/<?php echo $blog['Blog']['id']; ?>" onclick="return confirm('Are you want to remove this?')">Delete</a>
                                             </td>
                                          </tr>
                                          <?php 
                                             $cnt++;
					  ...
					  <div id="menu1" class="tab-pane fade">
					    <form action="<?php echo $this->webroot?>parlors/blogadd" method="post" accept-charset="utf-8" class="ajaxform" id="form-ui3" enctype="multipart/form-data">
