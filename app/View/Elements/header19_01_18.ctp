...
<section class="header">
    	<div class="headerTop">
				...
				<ul class="navbar-nav navPart">
					...
					<a class="nav-link dropdown-toggle" ata-toggle="dropdown" href="<?php echo $this->webroot ?>users/escortlist/F">Escort</a>
				...
				<div class="col-lg-12">
					<div class="logoPart">
						...
						<div class="languageSelection">
									...
									<ul class="socialLink">
										...
										<li><a href="#"><i class="fa fa-youtube"></i></a></li>
                                                    ...
                                                    <div class="lowerPart text-right">
                                                            <button type="button" class="btn btn-primary login"><i class="fa fa-lock mr-2"></i><a href="<?php echo $this->Html->url('/')?>users/logout" class="login sign_in_toggle">LogOut</a></button>
							...
							<div class="lowerPart text-right">
                                                            <button type="button" class="btn btn-primary login"><i class="fa fa-lock mr-2"></i><a href="javascript:void(0);" id="login" class="login sign_in_toggle">LogIn</a></button>
	...
	<section class="lowerNav">
		<nav class="navbar navbar-expand-sm navbar-dark">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item">
					<a class="nav-link" href="#">Classified Ads</a>
					</li>
					<li class="nav-item">
