                ...
                <section class="change-location-right">
                    <section class="hoverBG">
                        <section class="change-location-rit">
                            ...
                            <h4><img src="<?php echo  $this->Html->url('/') ?>images/girl-icon.png" alt=""><?php echo $total_escort;?><span>Girls</span></h4>
                        </section>
                    </section>
                </section>
            </section>
...
<section id="header-mc" style=" background:#a41ca5;">
    <section id="header-wrapper">
        <section id="m-menu">
            ...
            <ul>
                <li class="<?php echo ($controller=='users' and $action=='index')?'activenew':''; ?>"> <a href="<?php echo  $this->Html->url('/')?>">Home</a></li>
                <li class="<?php echo ($controller=='users' and $action=='escortlist')?'activenew':''; ?>"> <a href="<?php echo $this->webroot ?>users/escortlist/F">Escorts</a>
<!--                    <ul>
                        <li> <a href="<?php echo $this->webroot ?>users/escortlist/F">Female</a></li>
                        <li> <a href="<?php echo $this->webroot ?>users/escortlist/M">Male</a></li>
                ...
                <li class="<?php echo ($controller=='pages' and $action=='agencies')?'activenew':''; ?>"> <a href="<?php echo $this->webroot?>agencies/">Agencies</a></li>
                <li class="<?php echo ($controller=='pages' and $action=='clubs')?'activenew':''; ?>"> <a href="<?php echo $this->webroot?>clubs/">Clubs</a></li>
                <li class="<?php echo ($controller=='users' and $action=='massageparlours')?'activenew':''; ?>"> <a href="<?php echo $this->webroot ?>users/massageparlours">Massage Parlours</a></li>
                ...
                <li class="<?php echo ($controller=='users' and $action=='escorttours')?'activenew':''; ?>"> <a href="<?php echo $this->webroot ?>users/escorttours">Escorts On Tour</a></li>
                <!-- <li style="top: 100%;"> <a href="<?php echo $this->Html->url('/');?>classified-ads">Classifieds</a></li> -->
                <li class="<?php echo ($controller=='pages' and $action=='shop')?'activenew':''; ?>"> <a href="<?php echo $this->webroot ?>pages/shop">Shop</a>
                    <ul>
                ...
                <li class="<?php echo ($controller=='users' and $action=='escortlist')?'activenew':''; ?>"> <a href="<?php echo $this->Html->url('/');?>advertisements/listing">Advertise</a></li>
            </ul>
            <section class="change-location">
                <section class="change-location-right">
                    <section class="hoverBG">
...
.second_banner{width: 100%; overflow:hidden;}
    ...
    #m-menu ul li a {padding:0 13px !important; font-size:17px !important;}
    .activenew  { border-bottom: 2px solid #d32fa1 !important;}
    .activenew1  { background: #d32fa1 !important;}
</style>
<script>
$(document).ready(function(){
  $('.bxslider').bxSlider({
