        ...
        <ul class="notification-menu">
            ...
            <li>
                ...
                <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                    <li><a href="<?php echo $this->webroot . 'admin/users/edit/1' ?>"><i class="fa fa-user"></i>  Profile</a></li>
        ...
        <div class="navbar-inner">
                <div class="container-fluid">
                        ...
                        <div class="nav-collapse collapse">
                                ...
                                <ul class="nav">
                                        <li <?php if ($this->params['controller'] == 'site_settings' && $this->params['action'] == 'admin_edit') { ?>class="active"<?php } ?>>
                                            <a href="<?php echo($this->webroot) ?>admin/site_settings/edit/1">Settings</a>
                                        </li>
                                        <li class="dropdown <?php if ($this->params['controller'] == 'users' && $this->params['action'] != 'admin_dashboard') { echo 'active'; } ?>">
                                                <a href="javascript:void(0)" role="button" class="dropdown-toggle" data-toggle="dropdown">Admin <i class="caret"></i></a>
                                                <ul class="dropdown-menu">
                                                        <li><a tabindex="-1" href="<?php echo($this->webroot) ?>admin/users/list">Admin List</a> </li>
                                                </ul>
                                        </li>
                                </ul>
                        </div>
