<div class="col-lg-3">
    <div class="dashboardLeftPart">
        <ul class="list-unstyled">
            <li class="active"><a href="<?php echo $this->Html->url('/') ?>agencies/agencydashboard"><i class="fa fa-home"></i>Dashboard</a></li>
            <li><a href="<?php echo $this->Html->url('/') ?>agencies/editagentprofile"><i class="fa fa-user" aria-hidden="true"></i>My Agency Profile</a></li>
            <li><a href="<?php echo $this->Html->url('/') ?>agencies/addescort"><i class="fa fa-plus-circle"></i>Manage Escorts</a></li>
            <li><a href="<?php echo $this->Html->url('/') ?>agencies/membership"><i class="fa fa-plus-circle"></i>Upgrade Membership</a></li>
<!--                                                        <li><a href="<?php echo $this->Html->url('/') ?>agencies/postbanner"><i class="fa fa-plus-circle"></i>Post Banner</a></li>-->
<!--                                                        <li><a href="<?php echo $this->Html->url('/') ?>agencies/membership"><i class="fa fa-plus-circle"></i>Upgrade Membership</a></li>-->
            <li><a href="<?php echo $this->Html->url('/') ?>agencies/mypphoto"><i class="fa  fa-file-photo-o"></i>Photo Gallery</a></li>
            ...
            <li><a <?php
                ...
                if ($permissions->upload_video) {
                    ...
                    <?php } ?>><i class="fa fa-video-camera" aria-hidden="true"></i>Video Gallery</a></li>

            <li><a <?php if ($permissions->set_happyhour) { ?>
                        href="<?php echo $this->Html->url('/') ?>agencies/happy_hours_escorts"
                    <?php } else { ?>
...
<li><a href="<?php echo $this->Html->url('/')?>agencies/rateandtarrif"><i class="fa fa-plus-circle"></i>  Rates & Tariff </a>
            ...
            <li><a <?php
                if ($permissions->messageing) {
                    ...
                    <?php } ?>><i class="fa  fa-envelope"></i>Email Messages<sup class="unread unreadCount" id="unreadmsg">0</sup></a></li>
            ...
            <li><a <?php
                ...
                <?php } else { ?>
                    ...
                    <?php } ?>><i class="fa  fa-file-code-o"></i>Manage Blogs</a></li>
...
if ($permissions->add_onservice) {
    ?> 
            ...
            <li><a href="<?php echo $this->Html->url('/') ?>agencies/accountsettings"><i class="fa fa-gears"></i>Account Settings</a></li>
            
            
            
            <li><a href="<?php echo $this->Html->url('/')?>agencies/jobs"><i class="fa fa-crosshairs"></i> Adult Jobs</a></li>



            <!--        <li><a <?php if ($permissions->manage_onlineshop) { ?>
                               href="<?php echo $this->Html->url('/') ?>agencies/agentshops" onclick="show_modal('Manage Shop','manage_onlineshop')"
