					  ...
					  <div id="home" class="tab-pane in active">
					      <table class="table table-hover">
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                 <a href="<?php echo $this->webroot; ?>clubs/blog_edit/<?php echo $blog['Blog']['id']; ?>">Edit</a>
                                                 <a href="<?php echo $this->webroot; ?>clubs/blog_delete/<?php echo $blog['Blog']['id']; ?>" onclick="return confirm('Are you want to remove this?')">Delete</a>
                                             </td>
                                          </tr>
                                          <?php 
                                             $cnt++;
