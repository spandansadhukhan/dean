                                                            ...
                                                            <section class="upc clear">
                                                                <form action="" method="post" accept-charset="utf-8" class="" id="form1" enctype="multipart/form-data">                  <section class="upc-tom1">
                                                                        <div id="uploader" style="max-width:900px;">
                                                                            <form action="" method="post" accept-charset="utf-8" class="ajaxform" id="foema" enctype="multipart/form-data">						<input type="hidden" name="uid" value="<?php echo $user['Club']['id']?>" /> 
...
<script>
    function deleteVideo(id) {
        $.ajax({
            type: "POST",
            url: "<?php echo $this->Html->url('/'); ?>clubs/deletevideo/",
            //dataType: "json",
            data: {id: id}
        }).done(function (msg) {          
            $("#image_"+id).hide();
            window.location.href = "<?php echo Router::url(array('controller' => 'clubs', 'action' => 'myvideo')); ?>";
        });
    }
</script>