                                                                            ...
                                                                            <form action="" method="post" accept-charset="utf-8" class="ajaxform" id="edit_basic">
                                                                                ...
                                                                                <div class="form-profile-block">
                                                                                    ...
                                                                                    <div class="inputContainer">
                                                                                        <div class="section">
                                                                                            <label class="field">
                                                                                                <input type="text" placeholder="Club Name" class="gui-input" id="from" value="<?php echo $this->request->data['User']['org_name']?>" name="org_name">
                                                                                            </label>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
...
<?php $remain_charecter=$permissions->my_profile-$count_charecter;?>
<div class="clr"></div>
<!-- Modal -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">About Club</h4>
            </div>
...
<script>
    function saveAboutMe(id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo $this->Html->url('/'); ?>clubs/editClubAbout/",
            //dataType: "json",
