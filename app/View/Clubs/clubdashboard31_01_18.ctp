                                                ...
                                                <div class="right-my-account-blocks">
                                                    <div class="detail-heading">
                                                        ...
                                                        <section class="title-left">
                                                            <h1 style="display:inline-block;"> My Club Home</h1>
                                                    ...
                                                    <div class="right-my-account-blocks-inner">
                                                                ...
                                                                <div class="modal fade" id="userProfileImage" style="" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content" id="addrEditModal">
                                                                            <form action="<?php echo $this->webroot; ?>clubs/clubdashboard" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <section class="profile-info">
                                                            <a href="<?php echo $this->webroot; ?>clubs/editclubprofile" class="r_butt edi_pro" style="text-align: center;width: 100px;"> Edit Your Profile </a>
...
<dt>
    ...
    <dd><?php echo $permissions->add_escort_profile==-1?'Unlimited':$permissions->add_escort_profile?></dd>
        ...
        <dt>
    Upload Videos  </dt>
    <dd><?php echo $permissions->upload_video?>Second Videos per Escort</dd>
<dt>
    Club Profile Description</dt>
