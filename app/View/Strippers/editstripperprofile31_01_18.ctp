                                                                        ...
                                                                        <div class="smart-forms smart-container">
                                                                            ...
                                                                            <form action="" method="post" accept-charset="utf-8" class="ajaxform" id="form-ui">
                                                                                ...
                                                                                <div class="form-profile-block" style="margin-bottom: 14px;">
                                                                                    ...
                                                                                    <div class="form-profile-block" style="margin-bottom: 14px;">
                                                                                    <label class="pl">Stripper Type </label>
                                                                                    <div class="inputContainer">
                                                                                    <div class="section" style="margin: 0;">
                                                                                    <div class="option-group field">
                                                                                    <label class="option">
                                                                                    <input type="radio" required="required" <?php echo $this->request->data['User']['srtipper_type'] != "C" ? '' : 'checked'; ?> name="srtipper_type" value="C">
                                                                                    <span class="radio"></span> Club </label>
                                                                                    <label class="option">
                                                                                    <input type="radio" required="required" <?php echo $this->request->data['User']['srtipper_type'] != "A" ? '' : 'checked'; ?> name="srtipper_type" value="A" >
                                                                                    <span class="radio"></span> Agency </label>
                                                                                    </div><!-- end .option-group section -->
                                                                                    </div>
                                                                                    </div>
                                                                                    </div>
