          	   ...
          	   <section class="f-section f-whiteSmoke f-border-top  f-bottom-100" id="section-autoplay">
					<div class="f-content autoplay">
						...
						<ul class="z-tabs-nav z-tabs-mobile" style="display: none;">
							...
							<li data-link="inbox" class="z-tab"><a class="z-link">Credits Purchase History</a></li>
							<li data-link="rewards" class="z-tab"><a class="z-link">Credits Rewards</a></li>
							<li data-link="outbox" class="z-tab"><a class="z-link">Credits Expend History</a></li>
                            ...
                            <section class="no-record" id="noitem" >No Credits Purchased.</section>
                        </div>
                            ...
                            <section class="no-record" id="noitem" >No Transactions History Found.</section>
                        </div>
                        												</div>
											 </div>
									<!-- Tab4 End-->
