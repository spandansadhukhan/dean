					...
					<div class="tab-content">
					  <div id="home" class="tab-pane in active">
                            ...
                            <thead>
                                ...
                                <?php //echo $this->Session->read('fuid'); ?>
                            </table>
					  ...
					  <div id="menu1" class="tab-pane ">
					  	...
					  	<div class="mt-3 mb-3 jobHeading">
                                                     <form action="<?php echo $this->webroot ?>strippers/addescort" method="post" accept-charset="utf-8" class="ajaxform"  enctype="multipart/form-data"> 
