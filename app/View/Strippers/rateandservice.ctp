                    ...
                    <div class="col-lg-12">
                        <div class="newServices p-4">
                            ...
                            <form method="post" accept-charset="utf-8" class="ajaxform" id="form-ui4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12">
                                        <select class="form-control selectField" id="selectServ" onchange="add_services(this)">
                        ...
                        <div class="newServices p-4">
                            ...
                            <form method="post" accept-charset="utf-8" class="ajaxform" id="form-ui12">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-12">Add New Categories:</label>
                                    <div class="col-lg-12">
                                        <select class="form-control selectField category_name" id="selectCat" onchange="add_category(this)">
