...
<div class="wrapper">
      ...
      <section class="panel">
		  ...
		  <div class="col-sm-9 col-lg-4"> 
		    <div class="widget-simple">
		      <div class="widget-icon pull-left themed-background animation-fadeIn"> <i class="fa fa-file-text"></i> </div>
		      <h3 class="widget-content text-right animation-pullDown"> <strong>Total</strong><br>
		        <small>1</small> </h3>
		    </div>
		   </div>
		  <div class="col-sm-9 col-lg-4">
		    <div class="widget-simple">
		      ...
		      <i class="fa fa-check-square-o fa-1x"></i> </div>
		      <h3 class="widget-content text-right text-success animation-pullDown"> <strong>Active</strong><br>
		        <small>1</small> </h3>
		    </div>
		  </div>
		  <div class="col-sm-9 col-lg-4">
		    <div class="widget-simple">
		      ...
		      <i class="fa fa-exclamation fa-1x"></i> </div>
		      <h3 class="widget-content text-right text-warning animation-pullDown"> <strong>Inactive</strong><br>
		        <small>0</small> </h3>
		    </div>
		  </div>
  ...
  <div class="row gap_row">
    <div class="col-sm-12">
      <section class="panel">
        <header class="panel-heading"> Sub Admin Users (Total Records: <?php echo $total_user;?>) </header>
        ...
        <div class="table-options clearfix" style=" background-color:#fff">
          ...
          <div class="btn-group btn-group-sm pull-right"> <a id="style-hover" class="btn btn-primary gap_up gap_up_down" title="" data-toggle="tooltip" href="<?php echo $this->webroot;?>admin/users/addsubadmin" data-original-title="Add New Subadmin">Add New</a> </div>
        </div>
	    ...
	    ?>
              <tr class="gradeX">
                ...
                <td class="text-center"><div class="btn-group btn-group-sm"> <a href="javascript:void(0);" onclick="getViewUser(<?php echo $user['User']['id']; ?>)" class="btn btn-default enable-tooltip view-record" data-original-title="View Record"><i class="fa fa-search"></i></a> <a href="<?php echo $this->webroot;?>admin/users/editsubadmin/<?php echo $user['User']['id']; ?>"  class="btn btn-default enable-tooltip view-record btn btn-primary" data-original-title="View Record"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> </div></td>
              </tr>
              <?php endforeach; ?>
              <!--<tr>
            <td colspan="8">
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Sub Admin Detail</h4>
      </div>
