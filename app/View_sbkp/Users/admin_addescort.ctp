...
<div class="wrapper">
  <div class="row">
    <div class="col-lg-12">
      <section class="panel">
      <header class="panel-heading"> Add Escort </header>
      ...
      <div class="panel-body">
        <div class="form"> <?php echo $this->Form->create('User',array('enctype'=>'multipart/form-data','class'=>'cmxform form-horizontal adminex-form','id'=>'signupForm','onsubmit'=>'return valid()')); ?>
          <div class="form-group ">
            ...
            <div class="col-lg-10"> <?php echo $this->Form->input('name',array('label'=>false,'required'=>'required','class'=>'form-control','placeholder'=>'Escort Name')); ?> </div>
          </div>
          <div class="form-group ">
          ...
          <header class="panel-heading"> Varification Status Information </header>
          <div class="form-group ">
