                ...
                <div class="col-lg-12">
				   ...
				   <div class="row">
					<div class="col-sm-2"><strong>Id</strong></div>
                                        <div class="col-sm-10"><?php echo h($types['BodyType']['id']); ?> </div>
                                    </div>
					<div class="clearfix"></div>
				    <div class="row">
					<div class="col-sm-2"><strong>Body Type</strong></div>
                                        <div class="col-sm-10"><?php echo h($types['BodyType']['body_type']); ?></div>
                                    </div>
				
				<div class="clearfix"></div>
				    <div class="row">
					<div class="col-sm-2"><strong>Active</strong></div>
                                        <div class="col-sm-10"><?php echo h($types['BodyType']['is_active']==1?'Yes':'No'); ?></div>
                                    </div>
				 <div class="clearfix"></div>
