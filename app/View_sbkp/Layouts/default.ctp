                    ...
                    <nav class="navbar navbar-inverse">
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse">
                            <ul class="nav navbar-nav">
                                <li><a href="<?php echo $this->webroot;?>pages/home">Home</a></li>
                                <li><a href="<?php echo $this->webroot;?>pages/about-us">About US</a></li>
                                <li><a href="<?php echo $this->webroot;?>pages/advertise-jobs">advertise jobs</a></li>
                                <li><a href="<?php echo $this->webroot;?>pages/car-for-sale">cars for sale</a></li>
                                <li><a href="<?php echo $this->webroot;?>pages/employment">employment</a></li>
                                <li><a href="<?php echo $this->webroot;?>">dating</a></li>
                                <li><a href="<?php echo $this->webroot;?>">male escort</a></li>
                                <li><a href="<?php echo $this->webroot;?>">female escorts</a></li>
                            </ul>
                        </div>
                    </nav>
                    <?php
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="footer-box">
                                                    <ul class="footer-links">
                                                        ...
                                                        <li><a href="<?php echo $this->webroot;?>pages/employment">Employment</a></li>
                                                        <li><a href="<?php echo $this->webroot;?>">Dating</a></li>
                                                        <li><a href="<?php echo $this->webroot;?>pages/male-female-escort">Male and Female Escort</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="footer-box">
                                                    <ul class="footer-links">
                                                        <li><a href="<?php echo $this->webroot;?>pages/home">Home</a></li>
                                                        <li><a href="<?php echo $this->webroot;?>pages/about-us">About Us</a></li>
                                                        <li><a href="<?php echo $this->webroot;?>pages/contact-us">Contact Us</a></li>
                                                        <li><a href="<?php echo $this->webroot;?>pages/terms-conditions">Terms & Conditions</a></li>
                                            ...
                                            <div class="col-sm-4">
                                                <ul class="footer-links">
                                                    ...
                                                    <li><a href="<?php echo $this->webroot;?>pages/latest-blog">Our Latest Blogs</a></li>
                                                    <li><a href="<?php echo $this->webroot;?>">Reviews</a></li>
                                                    <li><a href="<?php echo $this->webroot;?>pages/latest-status">Latest Status</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
