        ...
        <div class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    {
                    ?>
                    <a href="" onclick="disable(<?php echo $payment['PaymentSetting']['pay_through_credit'];?>)"><button class="btn btn-success" >Disable</button></a>
                    <?php
                    }
                    else
                    {    
                    ?>
                    <a href="" onclick="enable(<?php echo $payment['PaymentSetting']['pay_through_credit'];?>)"><button class="btn btn-warning" >Enable</button></a>
                    <?php
                    }
                    ?>
                                        </div>
