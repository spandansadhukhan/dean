<!-- left side start-->
    <div class="left-side sticky-left-side">
		...
		<li class="menu-list">
                   <a href="#"><i class="fa fa-cogs sidebar-nav-icon"></i>General Settings</a>
                    <ul class="sub-menu-list">
                        ...
                        <li class="">
                           <a href="<?php echo $this->webroot.'admin/credits/';?>">Credit Settings</a>
                        </li>
                        <li class="">
		...
		<li class="menu-list">
		   ...
		   <ul class="sub-menu-list">
                        <li class="">
                            <a href="<?php echo $this->webroot.'admin/users/userindex';?>">All Users</a>
                        </li>
                        <li class="">
                            <a href="<?php echo $this->webroot.'admin/users/adduser';?>">Add New User</a>
                        </li>
                    </ul>
                </li>
		<li class="menu-list">
