                    ...
                    <section class="all-pins-do">
                        <div class="in-content">
                            <div class="left" id="breadcrumbsdiv">
                                <div class="left" id="breadcrumbstext"> <span><a href="javascript:void(0)"><span itemprop="title">
                                                Home              </span></a></span> \ <span><a href="javascript:void(0)"><span itemprop="title">
                                                United Kingdom              </span></a></span> \ <span><a href="javascript:void(0)"><span itemprop="title">
                            ...
                            <div class="profile-detail-m">
                                <div class="detail-heading">
                                    <section class="title-left">
                                        <h1 style="display:inline-block;">
                                            Patty                                    <img src="<?= $this->Html->url('/') ?>images/porn-star.png" style="width: 40px;" title="Pornstar" alt="" />
                                    ...
                                    <div id="demo-tabs"  class="marginBottom z-tabs-icons2 z-icons-dark  z-icons-large2 z-multiline hover medium z-shadows
                                        ...
                                        <div class="h-content2 z-container">
                                            <div class="z-content" style="height:auto;">
                                                <ul id="laod_images">
                                                    <li style="margin-bottom: 10px;"> <a class="fancybox-effects-a" data-fancybox-group="gallery" href="javascript:void(0)"> <img src="<?= $this->Html->url('/') ?>images/o_1ag2pbrth159j1lm21betv41ns9a1460382567-0x0.jpg" alt="" /></a> </li>
                                                    <li style="margin-bottom: 10px;"> <a class="fancybox-effects-a" data-fancybox-group="gallery" href="javascript:void(0)"> <img src="<?= $this->Html->url('/') ?>images/o_1ag652h3e1dauvioms6pe7ko7a1460493538-0x0.jpg" alt="" /></a> </li>
                                                    <li>
                                                    </li>
                                                    <div class="clr"></div>
                                                </ul>
                                ...
                                <div class="right-detail-part">
                                    ...
                                    <div class="profile-bio-rt">
                                        <p style="min-height:200px;"> <?php echo nl2br($user['User']['about'])?>  </p>
                                        <div class="clr"></div>
                                        <br />
                                        <h4 style="font-size: 20px;font-family: proxima_novalight;">
                                            <a href=javascript:void(0)" target="_blank" rel="nofollow" class="nounder">
                                                <i class="fa fa-share-square-o"></i> http://mysite.com </a><br>
                                    ...
                                    <div class="profile-bio-rt-button">
                                        ...
                                        <div class="m-button new-s-bt">
                                            ...
                                            <a style="cursor:pointer" href="javascript:void(0)" class="reported_user_pop">
                                                <i class="fa fa-flag"></i><span id="vote"> My Report </span></a> </div>
                                    </div>
                                    <div class="clr"></div>
