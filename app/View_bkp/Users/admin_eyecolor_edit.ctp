...
<?php echo $this->Form->create('Eyecolor'); ?>
	<fieldset>
		<legend><?php echo __('Edit eye color'); ?></legend>
	<?php
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
				<?php echo $this->Form->create('Eyecolor',array('class'=>'cmxform form-horizontal adminex-for')); 
				echo $this->Form->input('id');
